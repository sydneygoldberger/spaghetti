...
function setup() {
  ...
  points = font.textToPoints("Spaghetti", windowWidth/8, windowHeight/1.8, windowWidth/3, {
  sampleFactor: .7});
...
function spaghetti(){
  for (let i = 0; i < points.length; i++){
    ...
    noStroke();
    image(img2, 10 * noise(i * .01), 30 * noise(i * .01), 25, 25);
    image(img1, 10 * noise(i * .01), 30 * noise(i * .01), 25, 25);
    image(img4, 10 * noise(i * .01), 15 * noise(i * .01), 15, 15);
    pop();
